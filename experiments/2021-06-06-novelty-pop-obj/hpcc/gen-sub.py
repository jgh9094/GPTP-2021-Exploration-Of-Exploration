...
fixed_params= {
    ...
    "SELECTION":SELECTION_PARAM["LEX_NOVELTY"],
    "MUTATE_PER":"0.007",
    "MEAN":"0.0",
    "STD":"1.0",
    "TOUR_SIZE":"8",
...
combos.add_exception({"OBJECTIVE_CNT": "100", "POP_SIZE": "500"})
...
def main():
    ...
    for condition_dict in combo_list:
        ...
        run_param_info["NOVEL_K"] = condition_dict["NOVEL_K"]
