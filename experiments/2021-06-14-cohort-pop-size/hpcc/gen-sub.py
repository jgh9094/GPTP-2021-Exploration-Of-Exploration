...
combos.add_val(
    "SELECTION",
    [
        SELECTION_PARAM["COHORT"]
    ]
)

combos.register_var("COH_LEX_PROP")
combos.add_val(
    "COH_LEX_PROP",
    [
        "1.0",
...
def main():
    ...
    for condition_dict in combo_list:
        ...
        run_param_info["COH_LEX_PROP"] = condition_dict["COH_LEX_PROP"]
        run_param_info["POP_SIZE"] = prop_to_pop[condition_dict["COH_LEX_PROP"]]
