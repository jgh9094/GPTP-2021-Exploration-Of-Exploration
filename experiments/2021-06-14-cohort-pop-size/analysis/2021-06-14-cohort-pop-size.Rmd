# Cohort lexicase with increased population size

## Overview

```{r}
# Relative location of data.
working_directory <- "experiments/2021-06-14-cohort-pop-size/analysis/"
# working_directory <- "./"
...
save_plot(
  paste(working_directory, "imgs/cohort-pop-size-panel.pdf", sep=""),
  grid,
  base_width=12,
  base_height=8
)
