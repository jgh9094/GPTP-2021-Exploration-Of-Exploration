...
working_directory <- "Hpcc/aml-reruns/2021-05-27-cardinality/analysis/"
...
elite_trait_ave_fit <- ggplot(
    data,
    aes(x=gen, y=elite_trait_avg, color=cardinality, fill=cardinality)
  ) +
  stat_summary(geom="line", fun=mean) +
  stat_summary(
    geom="ribbon",
...
ggplot(
    data,
    aes(x=evaluations, y=elite_trait_avg, color=cardinality, fill=cardinality)
  ) +
  stat_summary(geom="line", fun=mean) +
  stat_summary(
    geom="ribbon",
