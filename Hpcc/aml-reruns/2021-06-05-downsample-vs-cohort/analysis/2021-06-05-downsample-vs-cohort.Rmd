...
```{r}
ggplot(data, aes(x=evaluations, y=elite_trait_avg, color=selection_name)) +
  stat_summary(geom="line", fun=mean) +
  stat_summary(
    geom="ribbon",
    fun.data="mean_cl_boot",
...
```{r}
ggplot(data, aes(x=evaluations, y=unique_start_positions_coverage, color=selection_name)) +
  stat_summary(geom="line", fun=mean) +
  stat_summary(
    geom="ribbon",
    fun.data="mean_cl_boot",
